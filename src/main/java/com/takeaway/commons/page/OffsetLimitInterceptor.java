package com.takeaway.commons.page;
...
import com.takeaway.commons.page.Dialect;
import com.takeaway.commons.page.PageBounds;
import com.takeaway.commons.page.PageList;
import com.takeaway.commons.page.Paginator;
import com.takeaway.commons.page.PropertiesHelper;
import com.takeaway.commons.page.SQLHelp;
...
public class OffsetLimitInterceptor implements Interceptor {
	...
	public Object intercept(final Invocation invocation) throws Throwable {
		...
		final int limit = pageBounds.getPlimit();
		...
		boolean condition=dialect.supportsLimit()
				...
				countTask = new Callable() {
					public Object call() throws Exception {
						...
						if (cache != null && ms.isUseCache()) {
							...
							if (count == null) {
								count = SQLHelp.getCount(bufferSql.toString(),
										ms, parameter, boundSql, dialect);
								cache.putObject(cacheKey, count);
							}
						} else {
							count = SQLHelp.getCount(bufferSql.toString(), ms,
	...
	public void setPoolMaxSize(int poolMaxSize) {
		...
		if (poolMaxSize > 0) {
			...
			Pool = new ThreadPoolExecutor(poolMaxSize, poolMaxSize, 0L,
					TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>());
		} else {
			Pool = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60L,
